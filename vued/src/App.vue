...
export default {
  ...
  methods: {
    ...
    completeTodo(todoItem, index){
        ...
        localStorage.setItem(todoItem.context,JSON.stringify({'context':todoItem.context, 'isComplete':todoItem.isComplete}));
    },
   editTodo(todoItem,editTodoItem,index){
        localStorage.setItem(editTodoItem,JSON.stringify({'context':editTodoItem, 'isComplete':todoItem.isComplete}));
      localStorage.removeItem(todoItem.context);
      this.todoItems[index].context = editTodoItem;
        }
  },
  created() {
