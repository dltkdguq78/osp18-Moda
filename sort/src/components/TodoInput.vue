<template>
	...
	<div class ="Btns">
        <input type="radio" id="all" value="all" v-model="tagpicked" @click="TagremoveTodo('all')" style = "width:15px;">
        <label for="all">전체</label>
        <input type="radio" id="nomal" value="nomal" v-model="tagpicked" @click="TagremoveTodo('nomal')" style = "width:15px;">
        <label for="nomal">보통</label>
        <input type="radio" id="important" value="important" v-model="tagpicked" @click="TagremoveTodo('important')"  style = "width:15px;" >
        <label for="important">중요</label>
        <input type="radio" id="emergency" value="emergency" v-model="tagpicked" @click="TagremoveTodo('emergency')"  style = "width:15px;">
        <label for="emergency">긴급 </label>
		<button	v-for="btn in buttons.sort" :key="btn.class" :title="btn.title" v-on:click="sortTodo(btn.class)">
